...
var flow_path = 'D:/RPA/explore/Modules/eMail';

casper.start('about:blank', function() {
techo('about:blank' + ' - ' + this.getTitle() + '\n');});

casper.then(function() {for (n=1; n<=1; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block

casper.then(function() {{techo('py import os');
py_result = ''; if (!py_step('py import os'))
...
casper.then(function() {{techo('py import configparser');
py_result = ''; if (!py_step('py import configparser'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});

casper.then(function() {{techo('py os.startfile("outlook")');
py_result = ''; if (!py_step('py os.startfile("outlook")'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});

casper.then(function() {{techo('vision import ConfigParser'); var fs = require('fs');
if (!sikuli_step('vision import ConfigParser')) if (!fs.exists('for vision step'))
...
casper.then(function() {{techo('vision config = ConfigParser.ConfigParser()'); var fs = require('fs');
if (!sikuli_step('vision config = ConfigParser.ConfigParser()')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision config.read(\'C:\\\\config\\\\config.ini\')'); var fs = require('fs');
if (!sikuli_step('vision config.read(\'C:\\\\config\\\\config.ini\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision varEMailFile = config.get(\'Reports\', \'reportEMail\')'); var fs = require('fs');
if (!sikuli_step('vision varEMailFile = config.get(\'Reports\', \'reportEMail\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision tempEMFH = open(varEMailFile, \'r\')'); var fs = require('fs');
if (!sikuli_step('vision tempEMFH = open(varEMailFile, \'r\')')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision tempEMString = tempEMFH.read()'); var fs = require('fs');
if (!sikuli_step('vision tempEMString = tempEMFH.read()')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision tempEMFH.close()'); var fs = require('fs');
if (!sikuli_step('vision tempEMFH.close()')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('click D:/RPA/explore/Modules/eMail/NewMail.png'); var fs = require('fs');
if (!sikuli_step('click D:/RPA/explore/Modules/eMail/NewMail.png')) if (!fs.exists('D:/RPA/explore/Modules/eMail/NewMail.png'))
this.echo('ERROR - cannot find image file D:/RPA/explore/Modules/eMail/NewMail.png').exit(); else
this.echo('ERROR - cannot find D:/RPA/explore/Modules/eMail/NewMail.png on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('enter D:/RPA/explore/Modules/eMail/To.png as raju.surapuraju@causeway.com'); var fs = require('fs');
if (!sikuli_step('enter D:/RPA/explore/Modules/eMail/To.png as raju.surapuraju@causeway.com')) if (!fs.exists('D:/RPA/explore/Modules/eMail/To.png'))
this.echo('ERROR - cannot find image file D:/RPA/explore/Modules/eMail/To.png').exit(); else
this.echo('ERROR - cannot find D:/RPA/explore/Modules/eMail/To.png on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(Key.TAB)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.TAB)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('enter D:/RPA/explore/Modules/eMail/Subject.png as Invoices processed Today for JSWright'); var fs = require('fs');
if (!sikuli_step('enter D:/RPA/explore/Modules/eMail/Subject.png as Invoices processed Today for JSWright')) if (!fs.exists('D:/RPA/explore/Modules/eMail/Subject.png'))
this.echo('ERROR - cannot find image file D:/RPA/explore/Modules/eMail/Subject.png').exit(); else
this.echo('ERROR - cannot find D:/RPA/explore/Modules/eMail/Subject.png on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type("Hi Raju Surapuraju")'); var fs = require('fs');
if (!sikuli_step('vision type("Hi Raju Surapuraju")')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('vision type(Key.ENTER)'); var fs = require('fs');
if (!sikuli_step('vision type(Key.ENTER)')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type("We have processed the following Invoices Today for JSWright bearing Catalogue Number: " + str(tempEMString))'); var fs = require('fs');
if (!sikuli_step('vision type("We have processed the following Invoices Today for JSWright bearing Catalogue Number: " + str(tempEMString))')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type("Thanks")'); var fs = require('fs');
if (!sikuli_step('vision type("Thanks")')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision type("Raju Surapuraju")'); var fs = require('fs');
if (!sikuli_step('vision type("Raju Surapuraju")')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});

casper.then(function() {{techo('click D:/RPA/explore/Modules/eMail/Send.png'); var fs = require('fs');
if (!sikuli_step('click D:/RPA/explore/Modules/eMail/Send.png')) if (!fs.exists('D:/RPA/explore/Modules/eMail/Send.png'))
this.echo('ERROR - cannot find image file D:/RPA/explore/Modules/eMail/Send.png').exit(); else
this.echo('ERROR - cannot find D:/RPA/explore/Modules/eMail/Send.png on screen').exit(); this.wait(0);}});

casper.then(function() {techo('wait 10');});
casper.wait(10000, function() {});

casper.then(function() {{techo('py os.system("taskkill /f /im outlook.exe")');
py_result = ''; if (!py_step('py os.system("taskkill /f /im outlook.exe")'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
