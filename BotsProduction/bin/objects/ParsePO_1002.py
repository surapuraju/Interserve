                    ...
                    while curr_row < num_rows:
                            ...
                            if poCType == 0:
                                ...
                                if nextLine == 'No' and countLine == 1:
                                    ...
                                    poFileHandle = open(poParsedFile, "a")
                                    poFileHandle.write(poDataString + '\n')
                                    poFileHandle.close()
